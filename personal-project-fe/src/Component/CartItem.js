            ...
            return (
                <li key={item.id} className="cart-item d-flex bg-body-secondary align-items-center">
                    ...
                    <div className="cart-item-details flex-grow-1">
                        ...
                        <p className="mb-1">Thương hiệu: <span className="fw-bold">{product?.brand.name}</span></p>
                ...
                <>
                    ...
                    <div className="cart-summary d-flex justify-content-between align-items-center border-top pt-2">
                        ...
                        <span className="fw-bold">
                            {Helper.formatPrice(
                                cartItems.reduce((total, item) => total + item.quantity * item.productDetail.price, 0)
                            )}
                        </span>
                    </div>
