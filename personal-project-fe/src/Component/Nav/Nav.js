...
function Nav() {
    ...
    return (<div className="border-bottom py-4 border-black">
            <div className="px-5 d-flex justify-content-between align-items-center">
                ...
                <div className="d-flex justify-content-end w-100">
                    ...
                    <div className="dropdown-product mx-2">
                        <NavLink href={"#"} className="fs-6 fw-medium dropdown-toggle" id="productDropdown">
                            sản phẩm
                        </NavLink>
                        <ul className="dropdown-menu" aria-labelledby="productDropdown">
                            <li><Link to="/nuoc-hoa-nam" className="dropdown-item">nước hoa nam</Link></li>
                            <li><Link to="/nuoc-hoa-nu" className="dropdown-item">nước hoa nữ</Link></li>
                            <li><Link to="/unisex" className="dropdown-item">unisex</Link></li>
                            <li><Link to="/nuoc-hoa-mini" className="dropdown-item">nước hoa mini</Link></li>
                            <li><Link to="/giftset" className="dropdown-item">giftset</Link></li>
                        </ul>
                    </div>
