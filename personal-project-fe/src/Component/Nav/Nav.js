...
function Nav() {
    ...
    return (
        <div className="border-bottom py-4 border-black">
            <div className="container d-flex justify-content-sm-between w-50 align-items-center">
                <NavLink href={"#"} className="fs-6 fw-medium">trang chủ</NavLink>
                <NavLink href={"#"} className="fs-6 fw-medium">giới thiệu</NavLink>
                <NavLink href={"#"} className="fs-6 fw-medium">thương hiệu</NavLink>
                <NavLink href={"#"} className="fs-6 fw-medium">logo</NavLink>
                <NavLink href={"#"} className="fs-6 fw-medium">sản phẩm</NavLink>
                <NavLink href={"#"} className="fs-6 fw-medium">blog</NavLink>
